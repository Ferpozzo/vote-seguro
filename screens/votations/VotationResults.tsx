...
export default class VotationResult extends React.Component {
        ...
        <ScrollView
          ...
          <Block style={styles.votations} flex>
            <Block style={styles.votationHeader} shadow card center space={'evenly'}>
              <Block center><Text color='#fff' h6>{votation.name}</Text></Block>
              <Block center><Text color='#fff' p size={13}>{votation.description}</Text></Block>
            </Block>
